    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
       <!--  <a class="navbar-brand brand-logo mr-5" href="dashboard.php"><img src="images/logo.svg" class="mr-2" alt="logo"/></a>
        ...
        <h1 style="color:#4B49AC">ADMIN</h1>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="view_user.php">Users</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="view_station.php">Station</a></li>
                <li class="nav-item"> <a class="nav-link" href="amenities.php">Amenities</a></li>
                <li class="nav-item"> <a class="nav-link" href="add_plug.php">Plug Type</a></li>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="tables1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="add_faq.php">Add FAQ</a></li>
                <li class="nav-item"> <a class="nav-link" href="view_faq.php">View FAQ</a></li>
                
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="view_rating.php"><span class="menu-title">Rating</span></a>
              
              <i class="menu-arrow"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="logout.php"><span class="menu-title">Logout</span></a>
